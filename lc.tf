...
resource "aws_launch_configuration" "master-eu-west-2a-masters-acirrustech-com" {
  name_prefix                 = "master-eu-west-2a.masters.acirrustech.com-"
  image_id                    = "ami-076731471501960ea"
  instance_type               = "t2.micro"
  key_name                    = "${aws_key_pair.kubernetes-acirrustech-com-a039e3a23854ef615a76dc5002b5b6fe.id}"
  ...
  user_data                   = "${file("${path.module}/data/aws_launch_configuration_master-eu-west-2a.masters.acirrustech.com_user_data")}"
...
resource "aws_launch_configuration" "master-eu-west-2b-masters-acirrustech-com" {
  name_prefix                 = "master-eu-west-2b.masters.acirrustech.com-"
  image_id                    = "ami-076731471501960ea"
  instance_type               = "t2.micro"
  key_name                    = "${aws_key_pair.kubernetes-acirrustech-com-a039e3a23854ef615a76dc5002b5b6fe.id}"
  iam_instance_profile        = "${aws_iam_instance_profile.masters-acirrustech-com.id}"
  security_groups             = ["${aws_security_group.masters-acirrustech-com.id}"]
  associate_public_ip_address = false
  user_data                   = "${file("${path.module}/data/aws_launch_configuration_master-eu-west-2b.masters.acirrustech.com_user_data")}"
...
resource "aws_launch_configuration" "master-eu-west-2c-masters-acirrustech-com" {
  name_prefix                 = "master-eu-west-2c.masters.acirrustech.com-"
  image_id                    = "ami-076731471501960ea"
  instance_type               = "t2.micro"
  key_name                    = "${aws_key_pair.kubernetes-acirrustech-com-a039e3a23854ef615a76dc5002b5b6fe.id}"
  iam_instance_profile        = "${aws_iam_instance_profile.masters-acirrustech-com.id}"
  security_groups             = ["${aws_security_group.masters-acirrustech-com.id}"]
  associate_public_ip_address = false
  user_data                   = "${file("${path.module}/data/aws_launch_configuration_master-eu-west-2c.masters.acirrustech.com_user_data")}"
